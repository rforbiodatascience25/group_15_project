...
However, because we lack sex data, estimates for both the male and female GFR will be calculated, and the average reported. This is not a medically sound way, and we are aware that the estimates are likely to be wrong. However, for our purposes, it suffices.
...
We see that most fall within stage 1 (normal) or stage 2 (mild). This confirms that our estimation is reasonable, and we can speculate that the relatively large number of individuals that fall within the mild to moderate category might be overestimated due to the lack of sex data.
