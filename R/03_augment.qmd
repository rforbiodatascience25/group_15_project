...
write_csv(kidney_augmented, 
          "../data/03_kidney_augmented.csv")
```
...
kidney_diagnoses <- kidney_augmented |> 
  select(id,
         diagnoses)
write_csv(kidney_diagnoses, "../data/04_kidney_diagnoses.csv")

kidney_vitals <- kidney_augmented |> 
  select(!diagnoses)
write_csv(kidney_vitals, "../data/05_kidney_vitals.csv")
